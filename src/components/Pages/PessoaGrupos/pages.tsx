...
export function PessoaGrupoPage() {
  ...
  const addItem = () => {
    if (!hasPermission("pessoas_grupos_create")) {
      toast.warning(
  ...
  const actions: TableActions<IPessoaGrupo> = {
    onUpdate: (id) => {
      if (!hasPermission("pessoas_grupos_update")) {
        toast.warning(
    ...
    onDelete: (id) => {
      if (!hasPermission("pessoas_grupos_delete")) {
        toast.warning(
    ...
    onDetails: (id) => {
      if (!hasPermission("pessoas_grupos_findOne")) {
        toast.warning(
